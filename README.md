...
![alt text](nginx.png)
Here the first line is the shebang so we are able to use bash script language.<br> Second line is refrencing the creds file that contains th eusername & ip of the AWS vm machine. <br>
```bash
